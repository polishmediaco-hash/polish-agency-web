...
## Corpus Check
- 85 files · ~613,674 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 950 nodes · 1547 edges · 74 communities (67 shown, 5 thin omitted)
...
2. `renderElement()` - 32 edges
3. `pushHistory()` - 32 edges
4. `pushHistory()` - 19 edges
5. `bindKeyboardShortcuts()` - 16 edges
6. `setupToolbar()` - 15 edges
7. `updatePosition()` - 15 edges
8. `renderControls()` - 15 edges
9. `selectElement()` - 15 edges
10. `findElement()` - 14 edges
